...
const BestSellers = ({ addToCart, searchTerm = "", setToast }) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {filteredBooks.length > 0 ? (
          filteredBooks.map((book) => (
            ...
            <div
              key={book.id}
              className="bg-[#081028] rounded-2xl overflow-hidden border border-slate-800 hover:-translate-y-2 transition duration-300 flex flex-col h-full"
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <h3 className="text-2xl font-bold mt-2 leading-snug min-h-[64px]">
                  {book.title}
                </h3>

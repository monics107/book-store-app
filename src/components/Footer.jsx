  ...
  return (
    <footer className="bg-[#020617] text-white px-6 lg:px-10 pt-16 pb-8">
      ...
      <div className="bg-gradient-to-r from-[#081028] via-[#0d1b52] to-[#081028] rounded-[30px] py-20 px-6 text-center">
        ...
        {success && (
          <div className="mt-6 inline-block bg-green-500/20 text-green-400 border border-green-500 px-5 py-3 rounded-xl">
        ...
        <form
          ...
          className="mt-10 max-w-3xl mx-auto bg-[#0b1640] border border-[#22306b] rounded-2xl p-2 flex flex-col sm:flex-row gap-3"
        >
          <input
            type="email"
            ...
            required
            className="flex-1 bg-transparent outline-none px-5 py-3 text-white placeholder-gray-500 text-lg"
          />

          <button
            type="submit"
            className="bg-orange-500 hover:bg-orange-600 transition-all duration-300 px-8 py-4 rounded-xl font-semibold shadow-lg shadow-orange-500/20"
          >
            Subscribe Now
          </button>
        </form>
      ...
      <div className="border-t border-gray-700 mt-16 pt-8 text-gray-400 text-lg">
        © 2026 LitMart. All Rights Reserved.
      </div>
